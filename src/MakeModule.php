...
class MakeModule extends Ans
{
     ...
     * @var string
     */
    protected $signature = 'ans:module {name} {--auth=tannq@ans-asia.com} {--path=Modules} {--permissions=0644} {--namespace=App\Modules}';
    ...
    public function handle()
    {
        ...
        $master = app_path("{$path}/Layouts/Views/master.blade.php");
        ...
        // create controller
        $this->line("");
        $moduleController = app_path("{$path}/{$module}/Controllers/{$module}Controller.php");
        ...
        $moduleRoutes = app_path("{$path}/{$module}/routes.php");
        ...
        // create test file
        $this->line("");
        $index = app_path("{$path}/{$module}/Views/index.blade.php");
