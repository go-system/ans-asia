...
class ModuleGenerate extends Ans
{
     ...
     * @var string
     */
    protected $signature = 'ans:setup {--auth=tannq@ans-asia.com} {--name=Modules} {--namespace=App\Modules}';
    ...
    public function handle()
    {
        ...
        $moduleServiceProvider = app_path("{$module}/ModuleServiceProvider.php");
        ...
        // $composer = app_path("{$module}/composer.json");
